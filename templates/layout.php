    ...
    <header class="main-header">
        <div class="main-header__container container">
            ...
            <form class="main-header__search" method="get" action="search.php">
                <input type="search" name="search" placeholder="Поиск записей">
                <input class="main-header__search-btn" type="submit" name="find" value="Найти">
            </form>
            <?php if(isset($_SESSION['user'])): ?>
            <a class="main-header__add-lot button" href="../add.php">Добавить запись</a>
            <?php endif; ?>
            <nav class="user-menu">

                <?php if (isset($username)): ?>
                    <div class="user-menu__image">
                        <img src="<?=$_SESSION['user']['profile_img'];?>" width="40" height="40" alt="Пользователь">
                    </div>
                    <div class="user-menu__logged">
                        <p><a href="#"</a><?=$username ?></p>
...
<footer class="main-footer">
    ...
    <div class="main-footer__bottom container">
        <div class="main-footer__copyright">
            <p>© 2018, BorodachBlog</p>
            <p>Интернет-блог бородачей</p>
        </div>
        ...
        <?php if(isset($_SESSION['user'])): ?>
        <a class="main-footer__add-lot button" href="../add.php">Добавить запись</a>
        <?php endif; ?>
    </div>
</footer>
</body>
